...
parser.add_argument("--root_path", type=str, default='/home/jiyang/jiyang/Projects/SeeSR/preset/datasets/train_datasets/training_for_dape', help='the dataset you want to tag.') # 
